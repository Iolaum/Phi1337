...
from a01d_tst_feature_engineering import preprocess_data
...
def main(return_text=False):
    ...
    df.to_pickle('../../dataset/bow_per_product_tst.pickle')
...
if __name__ == "__main__":
    ...
    if os.path.isfile("../../dataset/bow_per_product_tst.pickle"):
